...
window.onload = async () => {
    ...
    const buildTasksList = (tasks) => {
        ...
        if(tasks.length === 0) {
            // say need to ask tasks if dont have tasks
            ul.innerHTML = "<li class='empty'>You need to add tasks !!!</li>";
            return;
        }
    ...
    const buildItemsList = (taskID, items) => {
        ...
        ul.innerHTML = "";
        if(items.length === 0) {
            // say you need to add items if dont have items
            ul.innerHTML = "<li class='empty'>you need to add items !!!</li>";
            return;
        }
